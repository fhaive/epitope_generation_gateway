...
def plot_network_weight_sweep(summary):
    ...
    png = PLOT_DIR / "Supplementary_Figure_S5_panel_E_network_weight_sweep_similarity.png"
    svg = PLOT_DIR / "Supplementary_Figure_S5_panel_E_network_weight_sweep_similarity.svg"
...
def plot_leave_one_network(summary):
    ...
    png = PLOT_DIR / "Supplementary_Figure_S5_leave_one_network_metric_top10_overlap.png"
    svg = PLOT_DIR / "Supplementary_Figure_S5_leave_one_network_metric_top10_overlap.svg"
...
def main():
    ...
    pd.DataFrame(scenario_weight_rows).to_csv(TABLE_DIR / "Supplementary_Figure_S5_weighting_scenarios.tsv", sep="\t", index=False)
    meta.to_csv(TABLE_DIR / "Supplementary_Figure_S5_columns_used.tsv", sep="\t", index=False)
    scenario_df.to_csv(TABLE_DIR / "Supplementary_Figure_S5_epitope_scores_and_sensitivity_ranks.tsv.gz", sep="\t", index=False)
    comp.to_csv(TABLE_DIR / "Supplementary_Figure_S5_rank_stability_by_sample.tsv", sep="\t", index=False)
    summary.to_csv(TABLE_DIR / "Supplementary_Figure_S5_rank_stability_summary.tsv", sep="\t", index=False)
    pair_corr.to_csv(TABLE_DIR / "Supplementary_Figure_S5_feature_pairwise_correlations_by_sample.tsv", sep="\t", index=False)
    pair_corr_summary.to_csv(TABLE_DIR / "Supplementary_Figure_S5_feature_pairwise_correlations_summary.tsv", sep="\t", index=False)
    pair_corr_overall.to_csv(TABLE_DIR / "Supplementary_Figure_S5_feature_pairwise_correlations_overall.tsv", sep="\t", index=False)
    ...
    boxplot_metric(
        ...
        outbase=PLOT_DIR / "Supplementary_Figure_S5_panel_D_main_scenarios_top10_overlap",
    )
    ...
    boxplot_metric(
        ...
        outbase=PLOT_DIR / "Supplementary_Figure_S5_panel_C_full_rank_similarity",
    )
