...
# Reviewer round 2 coverage-sensitivity outputs
COVERAGE_OUT = OUT / "reviewer2_coverage_sensitivity" / "patched_builder_outputs"
COVERAGE_OUT.mkdir(parents=True, exist_ok=True)
CANDIDATE_OUT = COVERAGE_OUT / "egg_candidates.exact_relaxed_evidence_flags.tsv.gz"
MATCH_EXAMPLES_OUT = COVERAGE_OUT / "match_examples.exact_relaxed.tsv.gz"
ALL_MATCHES_OUT = COVERAGE_OUT / "all_matches.exact_relaxed.with_coverage.tsv.gz"
INVENTORY_OUT = COVERAGE_OUT / "candidate_evidence_inventory.tsv"
REFERENCE_SCAN_OUT = COVERAGE_OUT / "reference_scan_summary.tsv"
